...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "MIT-LICENSE", "README.rdoc", "Rakefile", "benchmark/active_support.rb", "benchmark/test.txt", "ext/utf8/extconf.rb", "ext/utf8/utf8.c", "lib/utf8.rb", "spec/spec_helper.rb", "spec/utf8_spec.rb"]
  ...
  s.test_files = ["spec/spec_helper.rb", "spec/utf8_spec.rb"]
